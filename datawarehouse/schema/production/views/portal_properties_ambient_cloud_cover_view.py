"""portal_properties_ambient_cloud_cover_view view Schema"""

JSON_SCHEMA = {
    "creationTime": "1652811102060",
    "description": "portal_properties_ambient_cloud_cover_view ",
    "etag": "MgSH/1sTd3FdjmOQLbIuaQ==",
    "id": "production-epbp:standardized_new.portal_properties_ambient_cloud_cover_view",
    "kind": "bigquery#table",
    "labels": {
        "hourlybuildingdata": "production"
    },
    "lastModifiedTime": "1653323401008",
    "location": "US",
    ...
    "selfLink": "https://bigquery.googleapis.com/bigquery/v2/projects/production-epbp/datasets/standardized_new/tables/portal_properties_ambient_cloud_cover_view",
    "tableReference": {
        "datasetId": "standardized_new",
        "projectId": "production-epbp",
        "tableId": "portal_properties_ambient_cloud_cover_view"
    },
    "type": "VIEW",
    "view": {
        "query": """
            SELECT DISTINCT DATETIME(ca.year, ca.month, ca.date, ca.hour, 0, 0) AS timestamp,
                                    ...
                                    sum(DISTINCT DATA * weight) AS sum_cloud_cover,
                                    avg(DISTINCT DATA * weight) AS avg_cloud_cover,
                    ...
                    WHERE mr.type = 'Ambient Cloud Cover'
