"""portal_properties_ambient_humidity_view  view Schema"""

JSON_SCHEMA = {
    "creationTime": "1652812118739",
    "description": "portal_properties_ambient_humidity_view ",
    "etag": "nd0hpyYu3INTazpG9AC97Q==",
    "id": "production-epbp:standardized_new.portal_properties_ambient_humidity_view",
    "kind": "bigquery#table",
    "labels": {
        "hourlybuildingdata": "production"
    },
    "lastModifiedTime": "1653323437679",
    "location": "US",
    ...
    "selfLink": "https://bigquery.googleapis.com/bigquery/v2/projects/production-epbp/datasets/standardized_new/tables/portal_properties_ambient_humidity_view",
    "tableReference": {
        "datasetId": "standardized_new",
        "projectId": "production-epbp",
        "tableId": "portal_properties_ambient_humidity_view"
    },
    "type": "VIEW",
    "view": {
        "query": """
            SELECT DISTINCT DATETIME(ca.year, ca.month, ca.date, ca.hour, 0, 0) AS timestamp,
                                            ...
                                            sum(DISTINCT DATA * weight) AS sum_humidity,
                                            avg(DISTINCT DATA * weight) AS avg_humidity,
                            ...
                            WHERE mr.type = 'Ambient Humidity'
