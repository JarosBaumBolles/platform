"""portal_properties_ambient_wind_speed_view view Schema"""

JSON_SCHEMA = {
    "creationTime": "1652815158785",
    "description": "portal_properties_ambient_wind_speed_view ",
    "etag": "U2XjfiUctaBKSrneI5jEIQ==",
    "id": "production-epbp:standardized_new.portal_properties_ambient_wind_speed_view",
    "kind": "bigquery#table",
    "labels": {
        "hourlybuildingdata": "production"
    },
    "lastModifiedTime": "1653323514907",
    "location": "US",
    ...
    "selfLink": "https://bigquery.googleapis.com/bigquery/v2/projects/production-epbp/datasets/standardized_new/tables/portal_properties_ambient_wind_speed_view",
    "tableReference": {
        "datasetId": "standardized_new",
        "projectId": "production-epbp",
        "tableId": "portal_properties_ambient_wind_speed_view"
    },
    "type": "VIEW",
    "view": {
        "query": """
            SELECT DISTINCT DATETIME(ca.year, ca.month, ca.date, ca.hour, 0, 0) AS timestamp,
                                    ...
                                    sum(DISTINCT DATA * weight) AS sum_wind_speed,
                                    avg(DISTINCT DATA * weight) AS avg_wind_speed,
                    ...
                    WHERE mr.type = 'Ambient Wind Speed'
