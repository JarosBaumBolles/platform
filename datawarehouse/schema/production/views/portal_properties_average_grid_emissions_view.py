"""portal_properties_average_grid_emissions_view view Schema"""

JSON_SCHEMA = {
    "creationTime": "1652815453684",
    "description": "portal_properties_average_grid_emissions_view ",
    "etag": "J5JUw9b4CoL2j1Pos6RCLw==",
    "id": "production-epbp:standardized_new.portal_properties_average_grid_emissions_view",
    "kind": "bigquery#table",
    "labels": {
        "hourlybuildingdata": "production"
    },
    "lastModifiedTime": "1653323532178",
    "location": "US",
    ...
    "selfLink": "https://bigquery.googleapis.com/bigquery/v2/projects/production-epbp/datasets/standardized_new/tables/portal_properties_average_grid_emissions_view",
    "tableReference": {
        "datasetId": "standardized_new",
        "projectId": "production-epbp",
        "tableId": "portal_properties_average_grid_emissions_view"
    },
    "type": "VIEW",
    "view": {
        "query": """
            SELECT DISTINCT DATETIME(ca.year, ca.month, ca.date, ca.hour, 0, 0) AS timestamp,
                    ...
                    WHERE mr.type = 'Average Grid Emissions'
