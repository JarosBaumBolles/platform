"""portal_properties_occupancy_view view Schema"""

JSON_SCHEMA = {
    "creationTime": "1652816232063",
    "description": "portal_properties_occupancy_view ",
    "etag": "t3H0PEq6g2deD4SuRk2hUQ==",
    "id": "production-epbp:standardized_new.portal_properties_occupancy_view",
    "kind": "bigquery#table",
    "labels": {
        "hourlybuildingdata": "production"
    },
    "lastModifiedTime": "1653323588200",
    "location": "US",
    ...
    "selfLink": "https://bigquery.googleapis.com/bigquery/v2/projects/production-epbp/datasets/standardized_new/tables/portal_properties_occupancy_view",
    "tableReference": {
        "datasetId": "standardized_new",
        "projectId": "production-epbp",
        "tableId": "portal_properties_occupancy_view"
    },
    "type": "VIEW",
    "view": {
        "query": """
            SELECT DISTINCT DATETIME(ca.year, ca.month, ca.date, ca.hour, 0, 0) AS timestamp,
                                    ...
                                    sum(DISTINCT DATA * weight) AS occupancy,
                                    avg(DISTINCT DATA * weight) AS avg_occupancy,
